...
/* MEMO POST */
export function memoPostRequest({ contents, file, isPrivate }) {
...
/* MEMO EDIT */
export function memoEditRequest(id, index, contents, isPrivate) {
    return (dispatch) => {
        dispatch(memoEdit());
        console.log(isPrivate);
        return axios.put('/api/memo/' + id, { contents, isPrivate })
        .then((response) => {
