    ...
    render() {
        ...
        const loginView = (
            <div>
                <div className="card-content">
                    <div className="row">
                        { inputBoxes }
                        <a onClick={this.handleLogin} className="waves-effect waves-light blue btn">ENTER</a>
                    </div>
                </div>
        ...
        return(
            <div className="container auth">
                <Link className="logo" to="/">TIMELINE</Link>
                <div className="card">
                    <div className="header blue darken-4 white-text center">
